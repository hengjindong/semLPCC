...
if __name__ == '__main__':
    ...
    for step, data in tqdm(enumerate(test_loader),
        ...
        ''' compression '''
        if args.compression_method == 'mpeg':
            pc_rec, path_bitstream = compression_mpeg(args.mpeg_quant,
                                                      pc_ori,
                                                      cur_name)
        elif args.compression_method == 'draco':
            pc_rec, path_bitstream = compression_draco(args.draco_qp,
                                                      pc_ori,
                                                      cur_name)
